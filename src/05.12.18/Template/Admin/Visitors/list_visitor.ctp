                                ...
                                <div class="portlet light portlet-fit portlet-form bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-green sbold uppercase">Add Visitor</span>
                                        </div>
                                        ...
                                        <form action="#" id="form_sample_2" method="post" enctype="multipart/form-data">
                                            <div class="form-body">
                                                <div class="form-group form-md-line-input">
                                                    <input type="text" class="form-control" name="fname" id="form_control_1" placeholder="Enter your fname" value="" required="">
                                                ...
                                                <div class="form-group form-md-line-input">
                                                    <input type="email" class="form-control" id="form_control_1" name="email" placeholder="Enter your email" required="">
                                                ...
                                                <div class="form-group form-md-line-input">
                                                    <input type="text" class="form-control" id="form_control_1" name="username" placeholder="Enter your username" required="">
                                                  ...
                                                  <div class="form-group form-md-line-input">
                                                    <input type="password" class="form-control" id="form_control_1" name="password" placeholder="Enter your password" required="">
                                                ...
                                                <div class="form-group form-md-line-input">
                                                    <input type="number" class="form-control" id="form_control_1" name="phone_no" placeholder="Enter phone number" required="">
...
<!--                                                <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="portlet box green">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-globe"></i>Visitor Listing </div>
                                        <div class="tools"> </div>
                                    </div>
                                    <div class="portlet-body">
                                               ...
                                               <td>
                                                   ...
                                                   <br/>
                                                     ...
                                                     <?php }else{  ?>
                                                          ...
                                                          <a href="visitors/change_status/<?php echo $celebrity_val->id;?> ">
				...
				type: "POST",
				evalScripts: true,
				url: '<?php echo $this->Url->build('/admin/visitors/ajax_customer_edit_data', true);  ?>',
				data: ({id:user_id}),
