								...
								<div class="card-box">
									<h4 class="m-t-0 header-title"><b>Supplier Edit</b></h4>
									<p class="text-muted font-13 m-b-30">
	                                </p>
									<form action="edit_supplier_data" method="post" name="theEditForm" 
									id="theEditForm" data-parsley-validate enctype="multipart/form-data">
									    <?php 
										$supplier_data= json_decode($supplier_data);
										?>
										<input type="hidden" name="edit_user_id" parsley-trigger="change"  class="form-control" id="edit_user_id" value="<?php echo $supplier_data->id;?>" />
										<div class="form-group">
											<label for="edit_fname">Supplier First Name*</label>
											<input type="text" name="edit_fname" parsley-trigger="change"  class="form-control" id="edit_fname" value="<?php echo $supplier_data->fname;?>" required="required" onkeypress='return ValidateAlpha(event)'/>
											<span id="error_edit_fname" style="color:#C00;"></span>
										</div>
										<div class="form-group">
											<label for="edit_lname">Supplier Last Name*</label>
											<input type="text" name="edit_lname" parsley-trigger="change" class="form-control" id="edit_lname" value="<?php echo $supplier_data->lname;?>"  required="required" onkeypress='return ValidateAlpha(event)' />
											<span id="error_edit_lname" style="color:#C00;"></span>
										</div>
										<div class="form-group">
											<label for="edit_username">Supplier Email*</label>
											<input type="text" name="edit_username" parsley-trigger="change" class="form-control" id="edit_username" value="<?php echo $supplier_data->username;?>"   onblur="validateEmail(this);" required="required"/>
											<span id="error_edit_username" style="color:#C00;"></span>
										</div>
										<div class="form-group">
											<label for="edit_phone_number">Supplier Phone Number*</label>
											<input type="text" name="edit_phone_number" parsley-trigger="change" class="form-control" id="edit_phone_number" value="<?php echo $supplier_data->phone_number;?>" required="required" maxlength=10 onkeypress='return isNumberKey(event)' />
											<span id="error_edit_phone_number" style="color:#C00;"></span>
										</div>
										<div class="form-group">
											<label for="edit_address">Supplier Address*</label>
											<textarea  name="edit_address" parsley-trigger="change" class="form-control" id="edit_address" required="required"><?php echo $supplier_data->address;?></textarea>
											<span id="error_edit_address" style="color:#C00;"></span>
										</div>
										<div class="form-group">
											<label for="edit_pswd_token">Supplier Password*</label>
											<input  name="edit_pswd_token" id="edit_pswd_token" type="text"  class="form-control" value="<?php echo $supplier_data->pswd_token;?>" required="required">
