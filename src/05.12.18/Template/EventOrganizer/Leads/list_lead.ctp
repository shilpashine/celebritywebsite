...
//alert(lead_id);exit;				
				...
				type: "POST",
				evalScripts: true,
				url: '<?php echo $this->Url->build('/manager/leads/viewRemark', true);  ?>',
...
//alert(lead_id);exit;				
				...
				type: "POST",
				evalScripts: true,
				url: '<?php echo $this->Url->build('/manager/leads/viewLead', true);  ?>',
				data: ({lead_id:lead_id}),
				success: function (data){
...
//alert(lead_id);exit;				
				...
				type: "POST",
				evalScripts: true,
				url: '<?php echo $this->Url->build('/manager/leads/fetchLead', true);  ?>',
				data: ({lead_id:lead_id}),
				success: function (data){
