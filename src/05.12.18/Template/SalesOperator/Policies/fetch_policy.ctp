										...
										<div class="form-group">
											...
											<input type="date" name="edit_policy_date" parsley-trigger="reminder"  class="form-control" id="edit_policy_date" value="<?php echo(date("d/m/Y", strtotime($policy_fetch_data->policy_date)));?>" required="required" />
										</div>
										<div class="form-group">
