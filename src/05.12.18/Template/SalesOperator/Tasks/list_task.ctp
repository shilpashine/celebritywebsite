                                        ...
                                        <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <?php echo strtoupper($task_val->phone);?> </td>
...
//alert(lead_id);exit;				
				...
				type: "POST",
				evalScripts: true,
				url: '<?php echo $this->Url->build('/salesoperator/tasks/viewTask', true);  ?>',
...
//alert(lead_id);exit;				
				...
				type: "POST",
				evalScripts: true,
				url: '<?php echo $this->Url->build('/salesoperator/tasks/fetchTask', true);  ?>',
				data: ({task_id:task_id}),
				success: function (data){
