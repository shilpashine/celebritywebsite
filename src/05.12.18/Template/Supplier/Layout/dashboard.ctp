...
<html>
    <head>
        ...
        <title>LRDEN</title>
        <?php
		echo $this->Html->css('admin-css/assets/plugins/chartist/dist/chartist.min.css'); 
    ...
    <body class="fixed-left">
		...
		echo $this->Html->script("admin-js/assets/plugins/peity/jquery.peity.min.js");
	    ?>
        <!-- jQuery  -->
		<?php
	    echo $this->Html->script("admin-js/assets/plugins/waypoints/lib/jquery.waypoints.js");
		echo $this->Html->script("admin-js/assets/plugins/counterup/jquery.counterup.min.js");
		echo $this->Html->script("admin-js/assets/plugins/chartist/dist/chartist.min.js");
		?>
        <!-- Knob -->
		<?php
		echo $this->Html->script("admin-js/assets/plugins/jquery-knob/jquery.knob.js");
		echo $this->Html->script("admin-js/assets/plugins/jquery-sparkline/jquery.sparkline.min.js");
		echo $this->Html->script("admin-js/assets/pages/jquery.dashboard.js");
