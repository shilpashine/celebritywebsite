                    <div class="container">
						...
						<div class="row">
							<div class="col-lg-6" id="show_data" name="show_data">
								<div class="card-box">
									<h4 class="m-t-0 header-title"><b>Shipping View</b></h4>
                        ...
                        <!--<div class="row">-->
                            <div class="col-sm-6">
                                <div class="card-box table-responsive">
                                    <h4 class="m-t-0 header-title"><b>Shipping List</b></h4>
                                    <p class="text-muted font-13 m-b-30">
                                        List Shippings
                                    </p>
...
function view_data(order_id){
		 $.ajax({
				type: "POST",
				evalScripts: true,
				url: '<?php echo $this->Url->build('/admin/shippings/view_data', true);  ?>',
				data: ({id:order_id}),
