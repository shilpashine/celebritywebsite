													...
													//echo($payment_request_data->order_amount);exit;
                                                        ...
                                                        <div class="form-body">
															...
															<div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input type="text" name="user" id="user"class="form-control input-circle" value="<?php echo $payment_request_data->user->username;?>" readonly>
																	<input type="hidden" name="user_id" id="user_id"class="form-control input-circle" value="<?php echo $payment_request_data->user->id;?>">
