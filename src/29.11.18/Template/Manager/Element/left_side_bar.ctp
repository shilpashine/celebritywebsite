...
<!--                            <li class="nav-item  ">
								...
								<ul class="sub-menu">
                                    <li class="nav-item  ">
                                        <a href="<?php echo $this->Url->build('/manager/tasks/list_task', true); ?>" class="nav-link ">
                                            <span class="title">Task Management</span>
                                        </a>
                                    </li>
                                </ul>
							...
							<li class="nav-item  ">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item  ">
                                        <a href="<?php echo $this->Url->build('/manager/users/edit_profile', true); ?>" class="nav-link ">
