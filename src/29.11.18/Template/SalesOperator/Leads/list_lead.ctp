<div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                <li>
                                    <a href="<?php echo $this->Url->build('/salesoperator/dashboards/index', true); ?>">Home</a>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="btn-group">
														...
														<button  class="btn green" onclick="add_new_lead();"> Add New
                                                            <i class="fa fa-plus"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                        ...
                                        <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                            ...
                                            <tbody>
												...
												<form method="post" action="#" id="leadAddForm" name="leadAddForm">
													...
													<td> <a class=""  href="#" > Add </a><a class=""  href="#" > View </a></td>
                                                    <td>
                                                        <a class="" href="#" onclick="add_lead();"> Save </a>
														<a class="" href="#" onclick="cancel_lead();"> Cancel </a>
                                                    </td>
                                                </tr>
												<?php 
												$i=1;
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <a class=""  href="#" onclick="open_add_modal(<?php echo $i;?>);"> Add </a><a class=""  href="#" onclick="open_view_modal(<?php echo $i;?>);"> View </a><input type="hidden" id="hidden_lead_id<?php echo $i;?>" name="hidden_lead_id<?php echo $i;?>" value="<?php echo $lead_val->id;?>"></td>
                                                    <td>
                                                        <a class="" href="#" onclick="edit_lead('<?php echo $i;?>');"> Edit </a>
														<a class="" href="#" onclick="view_lead('<?php echo $i;?>');"> View </a>
                                                    </td>
                                                </tr>
												<?php $i++;}}?>
                                            </tbody>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form action="addRemark" method="post" name="theForm" >
		<input type="hidden" id="lead_id" name="lead_id" />
										<div class="form-group">
											<label for="reminder">Reminder</label>
											<input type="text" name="reminder" parsley-trigger="reminder"  class="form-control" id="view_name" value="" required="required"/>
										</div>
										<div class="form-group">
											<label for="reminder">Meet On</label>
											<input type="date" name="met_on" parsley-trigger="reminder"  class="form-control" id="met_on" value="" required="required"/>
										</div>
										<div class="form-group">
											<label for="reminder">Remark</label>
											<textarea  name="remark" parsley-trigger="reminder"  class="form-control" id="remark" required="required"></textarea>
										</div>
  ...
  <div class="modal fade" id="myViewModal" role="dialog">
    <div class="modal-dialog" >
      ...
      <div class="modal-content">
		...
		<div class="modal-body" id="show_lead_view_data" name="show_lead_view_data">
  ...
  <div class="modal fade" id="myEditModal" role="dialog">
    <div class="modal-dialog" >
      ...
      <div class="modal-content">
		...
		<div class="modal-body" id="show_lead_edit_data" name="show_lead_edit_data">
...
//alert(lead_id);exit;				
				...
				type: "POST",
				evalScripts: true,
				url: '<?php echo $this->Url->build('/salesoperator/leads/viewRemark', true);  ?>',
...
function view_lead(index){
var lead_id=$('#hidden_lead_id'+index).val();
//alert(lead_id);exit;				
                $.ajax({
				type: "POST",
				evalScripts: true,
				url: '<?php echo $this->Url->build('/salesoperator/leads/viewLead', true);  ?>',
				data: ({lead_id:lead_id}),
				success: function (data){
				$('#show_lead_view_data').html();
				$('#show_lead_view_data').html(data);
...
function edit_lead(index){
var lead_id=$('#hidden_lead_id'+index).val();
//alert(lead_id);exit;				
                $.ajax({
				type: "POST",
				evalScripts: true,
				url: '<?php echo $this->Url->build('/salesoperator/leads/fetchLead', true);  ?>',
				data: ({lead_id:lead_id}),
				success: function (data){
				$('#show_lead_edit_data').html();
				$('#show_lead_edit_data').html(data);
