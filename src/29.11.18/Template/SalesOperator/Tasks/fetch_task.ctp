		                               ...
		                               <input type="hidden" id="edit_task_id" name="edit_task_id" value="<?php echo $task_fetch_data->id;?>"/>
										...
										<div class="form-group">
											...
											<input type="text" name="edit_phone" parsley-trigger="reminder"  class="form-control" id="edit_phone" value="<?php echo strtoupper($task_fetch_data->phone);?>" required="required"/>
										</div>
										<div class="form-group">
