								...
								<div class="portlet light portlet-fit portlet-form bordered">
                                    ...
                                    <div class="portlet-body">
										...
										<input type="hidden" name="edit_user_id" parsley-trigger="change"  class="form-control" id="edit_user_id" value="<?php echo $staff_data->id;?>" />
                                                ...
                                                <div class="form-group form-md-line-input">
                                                    <input type="email" class="form-control" id="form_control_1" name="email" placeholder="Enter your email" value="<?php echo $staff_data->email;?>"   onblur="validateEmail(this);" required="required">
                                                    ...
                                                    <span class="help-block">Please enter your email...</span>
                                                                                 ...
                                                                                 <div class="form-group form-md-line-input">
                                                    <input type="email" class="form-control" id="form_control_1" name="email" placeholder="Enter your username" value="<?php echo $staff_data->username;?>"   onblur="validateEmail(this);" required="required">
                                                ...
                                                <div class="form-group form-md-line-input">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-inline input-medium date-picker" name="dob" placeholder="Enter Dob" value="<?php if(!empty($dob[1])) { echo $dob[1]; }?>" >
