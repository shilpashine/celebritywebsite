...
<!-- Modal -->
  ...
  function seats_details(){
        ...
        function celebrity_video_url(){
                  ...
                  var div_new_count=parseInt(div_url_count)+1;
                  $("#div_url_count").val(div_new_count);
                   $("#url_cel").append('<div id="id_url_cel'+div_new_count+'"><input type="text" class="form-control" name="video_url[]" id="form_control_1"  placeholder=" Enter Video Url"/> <input type="button" class="btn green" name="submit" value="Delete" onclick="delete_ur_vel('+div_new_count+')"/> </div>')
