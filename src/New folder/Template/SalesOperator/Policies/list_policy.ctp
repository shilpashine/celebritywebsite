<div class="page-content">
                                        ...
                                        <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                            ...
                                            <tbody>
												...
												<form method="post" action="#" id="policyAddForm" name="policyAddForm">
                                                    ...
                                                    <td> <input type="text" id="gst" name="gst" onkeyup="cal_gross_premium();"/> </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="" href="#" onclick="edit_policy('<?php echo $i;?>');"> Edit </a>
														<a class="" href="#" onclick="view_policy('<?php echo $i;?>');"> View </a>
														<input type="hidden" id="hidden_policy_id<?php echo $i;?>" name="hidden_policy_id<?php echo $i;?>" value="<?php echo $policy_val->id;?>">
                                                    </td>
                                                </tr>
												<?php $i++;}}?>
                                            </tbody>
    ...
    <div class="modal-dialog" >
      ...
      <div class="modal-content">
		...
		<div class="modal-body" id="show_policy_view_data" name="show_policy_view_data">
  ...
  <div class="modal fade" id="myEditModal" role="dialog">
    <div class="modal-dialog" >
      ...
      <div class="modal-content">
		...
		<div class="modal-body" id="show_policy_edit_data" name="show_policy_edit_data">
...
function view_policy(index){
var policy_id=$('#hidden_policy_id'+index).val();
//alert(lead_id);exit;				
                $.ajax({
				type: "POST",
				evalScripts: true,
				url: '<?php echo $this->Url->build('/salesoperator/policies/viewPolicy', true);  ?>',
				data: ({policy_id:policy_id}),
				success: function (data){
				$('#show_policy_view_data').html();
				$('#show_policy_view_data').html(data);
...
function edit_policy(index){
var policy_id=$('#hidden_policy_id'+index).val();
//alert(lead_id);exit;				
                $.ajax({
				type: "POST",
				evalScripts: true,
				url: '<?php echo $this->Url->build('/salesoperator/policies/fetchPolicy', true);  ?>',
				data: ({policy_id:policy_id}),
				success: function (data){
				$('#show_policy_edit_data').html();
				$('#show_policy_edit_data').html(data);
