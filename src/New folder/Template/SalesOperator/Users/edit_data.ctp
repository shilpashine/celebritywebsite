                                                    ...
                                                    <form action="" class="form-horizontal" method="post">
                                                        <div class="form-body">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="email" name="email" id="email" class="form-control input-circle-right" placeholder="Email Address" value="<?php echo $user_data->email;?>" > <input type="hidden" name="user_id" id="user_id" class="form-control input-circle-right"  value="<?php echo $user_data->id;?>" ></div>
                                                                </div>
                                                            </div>
															<?php if(!empty($user_data)){
																if(!empty($user_data->user_details)){
																	$i=1;//pr($user_data);exit;							  
															...
															<div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input type="text" name="<?php echo $val_details->field;?>" id="id"class="form-control input-circle" placeholder="Enter text" value="<?php echo $val_details->value;?>">
                                                                </div>
                                                            </div>
															<?php $i++;}}}?>
                                                        </div>
