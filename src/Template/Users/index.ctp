							...
							<div class="account-content dashboard">
								...
								<div class="account-main">
									<div class="author clearfix">
                                                                                <a class="author-avatar" href="<?php echo $this->Url->build('/users/edit_profile', true); ?>"><?php if(!empty($user_data[0]['image'])){ echo $this->Html->image("medium/".$user_data[0]['image'], ['alt' => 'event','class'=>'logo-default']); }?></a>
										<div class="author-content">
											...
											<div class="author-info">
												...
												<p> Member since <?php echo $user_data[0]['created'];?></p>
											</div>
										</div>
									</div>
