...
<html>
	...
	<body class="fixed-left">
		...
		//echo $this->Html->script("admin-js/assets/plugins/moment/moment.js");
		//echo $this->Html->script("admin-js/assets/plugins/timepicker/bootstrap-timepicker.min.js");
		//echo $this->Html->script("admin-js/assets/plugins/mjolnic-bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js");
