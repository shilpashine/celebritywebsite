...
<input type="hidden" class="form-control" name="event_lat" id="lat" required=""  autocomplete="on" placeholder="Enter latitude" />
   ...
   <input type="hidden" class="form-control" name="event_country" required=""  id="country" autocomplete="on" placeholder="Enter Country" />
                                       <div class="input-group-append filler-sub list-sub">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-12 main-content">
						...
						<div id="carouselExampleIndicators<?php echo $k;?>" class="carousel slide side-bott" data-ride="carousel">
						  <div class="carousel-inner flexslider">
										...
										<div class="col-md-3 celeb">
											...
											<div class="product-info row">
												<a href="celebrities/celebrity_detail/<?php echo $val_category->celebrity_detail->id;?>"><?php echo $val_category->category_name; ?></a>
												<p class="product-price"><?php echo $val_category->celebrity_detail->name; ?></p>
												   <?php  if(!empty($AuthUser)) { 
                                                                                               ...
                                                                                               ?>
                                                                                                <p class="product-like" style="text-align:right;"><span class="follow"><a href="<?php if($count==0){?><?php echo $this->Url->build('/celebrities/follow/'.$val_category->celebrity_detail->id, true);  }else { echo "#"; }?>"><?php  if($count>0){echo 'Followed'; } else {echo 'Follow'; } ?></a> <?php if(!empty($val_category->celebrity_detail->event_follows)) { echo count($val_category->celebrity_detail->event_follows); }else { echo '0'; }?></span>
