                                        ...
                                        <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_4">
                                            ...
                                            <tbody>
												...
												foreach($celebrity_datas as $celebrity_val){
													//pr($celebrity_val->user);exit;
                                                                                                    if(!empty($celebrity_val->user)){
												$publish_date=explode('T',$celebrity_val->publish_date);
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $publish_date[0];?></td>
                                                    <td><?php if(!empty( $celebrity_val->news_celebrities)){
