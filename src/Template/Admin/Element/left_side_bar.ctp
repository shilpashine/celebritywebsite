                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item  ">
                                        <a href="<?php echo $this->Url->build('/admin/users/list_eventmanager', true); ?>" class="nav-link ">
                                            <span class="title">Add Event Organizer</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="<?php echo $this->Url->build('/admin/NewsDetails/news_lists', true); ?>" class="nav-link ">
                                            <span class="title">All Event Organizer News</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
