                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet box green">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-globe"></i>Comment Listing </div>
                                        <div class="tools"> </div>
                                    </div>
                                    <div class="portlet-body">
                                        <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_4">
                                            ...
                                            <tbody>
												...
												<?php 
												if(isset($data_all_comment[0]->event_comments)){
												
												foreach($data_all_comment[0]->event_comments as $celebrity_val){
													//pr($celebrity_val);exit;
												$start_date=explode('T',$celebrity_val->created);
                                                                                              
												?>
                                                <tr>
                                                    <td><?php echo $celebrity_val->name;?> </td>
                                                    <td><?php echo $celebrity_val->website;?></td>
                                                    <td><?php echo $celebrity_val->message;?></td>
                                                ...
                                                <td>
                                                     ...
                                                     <?php if($celebrity_val->status==1){ ?>
                                                        <a href="<?php echo $this->Url->build('/admin/eventDetails/comment_status/'.$celebrity_val->id, true);  ?>">
