										...
										<input type="hidden" name="edit_user_id" parsley-trigger="change"  class="form-control" id="edit_user_id" value="<?php echo $staff_data->id;?>" />
                                                ...
                                                <div class="form-group form-md-line-input">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-inline input-medium date-picker" name="dob" placeholder="Enter Dob" value="<?php if(!empty($dob[0])) { echo $dob[0]; }?>" >
                                                ...
                                                <div class="form-group form-md-line-input">
                                                  ...
                                                  <div class="form-group form-md-line-input">
                                                      ...
                                                      <?php 
                                                      if(!empty($staff_data->image)){
                                                      echo $this->Html->image("medium/".$staff_data->image, ['alt' => 'event','class'=>'logo-default']); }?>
