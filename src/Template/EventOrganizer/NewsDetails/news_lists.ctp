                                        ...
                                        <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_4">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="min-tablet">Is Approved</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><?php if($celebrity_val->status=='1'){ echo "Approved"; } else{ echo "Not Approved"; }?></td>
            ...
            function edit_data(user_id){
				...
				type: "POST",
				evalScripts: true,
				url: '<?php echo $this->Url->build('/event_organizer/NewsDetails/ajax_customer_edit_data', true);  ?>',
				data: ({id:user_id}),
          ...
          function delete_url11(el){
             ...
             function delete_url(el){
              ...
              function delete_div(fgd){
				...
				type: "POST",
				evalScripts: true,
				url: '<?php echo $this->Url->build('/event_organizer/NewsDetails/delete_multiimage', true);  ?>',
				data: ({id:fgd}),
				success: function (data){
                                    if(data==1){
                                   $("#image_id"+fgd).remove();
