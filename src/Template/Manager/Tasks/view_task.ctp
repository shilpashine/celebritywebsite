										...
										<div class="form-group">
											<label for="view_lname">Sur Name</label>
										...
										<div class="form-group">
											...
											<input type="text" name="view_phone" parsley-trigger="reminder"  class="form-control" id="view_phone" value="<?php echo $task_view_data->phone;?>" readonly />
										</div>
										<div class="form-group">
