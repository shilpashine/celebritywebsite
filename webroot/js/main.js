...
(function($) {
	...
	$(document).ready(function() {
		...
		//   	controls: false,
		// });
		$('.project-categogy').bxSlider({
			auto:true,
			pager:false,
			controls:true,
			
	  });
	  $('.project-categogy-two').bxSlider({
		auto:true,
		pager:false,
		controls:true,
...
$(function() {
	$(window).on("scroll", function() {
		if($(window).scrollTop() > 50) {
			$(".content-header").addClass("active-scroll");
		} else {
		   $(".content-header").removeClass("active-scroll");
		}
	});
});
...
$(document).ready(function() {
	...
	/*  [ celebrity listing ]
	- - - - - - - - - - - - - - - - - - - - */
	$('.celebrity-details-event-listing').bxSlider({
		minSliders:1,
		maxSliders:1,
		sliderWidth:320,
		auto:true,
