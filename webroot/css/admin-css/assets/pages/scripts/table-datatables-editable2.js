var TableDatatablesEditable = function () {
    ...
    var handleTable = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            jqTds[3].innerHTML = '<input type="text" class="form-control input-small" value="' + aData[2] + '">';
            jqTds[4].innerHTML = '<input type="text" class="form-control input-small" value="' + aData[4] + '">';
            jqTds[5].innerHTML = '<input type="text" class="form-control input-small" value="' + aData[5] + '">';
            jqTds[6].innerHTML = '<input type="date" class="form-control input-small" value="' + aData[6] + '">';
            ...
            jqTds[14].innerHTML = '<input type="date" class="form-control input-small" value="' + aData[14] + '">';
            jqTds[15].innerHTML = '<input type="date" class="form-control input-small" value="' + aData[15] + '">';
            ...
            jqTds[24].innerHTML = '<input type="date" class="form-control input-small" value="' + aData[24] + '">';
            jqTds[25].innerHTML = '<input type="text" class="form-control input-small" value="' + aData[25] + '">';
            jqTds[26].innerHTML = '<input type="text" class="form-control input-small" value="' + aData[26] + '">';
            jqTds[27].innerHTML = '<input type="text" class="form-control input-small" value="' + aData[27] + '">';
            jqTds[28].innerHTML = '<input type="date" class="form-control input-small" value="' + aData[28] + '">';
            jqTds[29].innerHTML = '<input type="date" class="form-control input-small" value="' + aData[29] + '">';
            jqTds[30].innerHTML = '<input type="date" class="form-control input-small" value="' + aData[30] + '">';
            jqTds[31].innerHTML = '<input type="date" class="form-control input-small" value="' + aData[31] + '">';




            jqTds[32].innerHTML = '<a class="edit" href="">Save</a>';
            jqTds[33].innerHTML = '<a class="cancel" href="">Cancel</a>';
        }
